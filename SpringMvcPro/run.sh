...
rm -r /opt/tomcat/apache-tomcat-8.5.53/webapps/SpringMvcPro-1.0-SNAPSHOT

cp -r /home/vikas/Downloads/SpringMvcPro/target/SpringMvcPro-1.0-SNAPSHOT/ /opt/tomcat/apache-tomcat-8.5.53/webapps
